...
final class MainModelTestSource extends ModelTestSource {
    ...
    MainModelTestSource (String fileName, String selector, String doneCondition, RunTime runTime, ProcedureRunner runner) {
        super (fileName, new Model (), runTime, runner);
        mSelector      = selector;
